    ...
    <PhoneShell>
      ...
      <div style={css('flex:1;display:flex;flex-direction:column;padding:0 24px')}>
        ...
        <Hoverable
          ...
          style={css('margin-top:22px;height:52px;border-radius:12px;background:#0B5FEF;box-shadow:0 10px 22px rgba(11,95,239,.30);display:flex;align-items:center;justify-content:center;font-size:16px;font-weight:700;color:#FFFFFF;cursor:pointer;letter-spacing:-.2px')}
        ...
        <div style={css('padding-bottom:38px;display:flex;justify-content:center;gap:6px;font-size:13.5px')}>
          ...
          <div style={css('color:#0B5FEF;font-weight:700;cursor:pointer;white-space:nowrap')}>Sign Up</div>
        </div>
      </div>
    </PhoneShell>
  );
