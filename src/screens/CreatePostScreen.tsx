  ...
  return (
    <PhoneShell>
      ...
      <div style={css('flex:none;height:52px;display:flex;align-items:center;padding:0 20px;gap:12px')}>
        ...
        <div style={css('flex:1;text-align:center;font-size:17px;font-weight:700;letter-spacing:-.35px')}>Create Post</div>
        <div style={css('font-size:15px;font-weight:700;color:#0B5FEF;cursor:pointer;flex:none')}>Post</div>
      </div>
      ...
      <div style={css('flex:none;margin:20px 20px 0;height:52px;border:1px solid #EAEEF4;border-radius:12px;display:flex;align-items:center;padding:0 14px;gap:10px;cursor:pointer;background:#fff')}>
        ...
        <div style={css('font-size:14.5px;font-weight:600')}>Public</div>
      ...
      <div style={css('flex:none;padding:22px 20px 0')}>
        <div style={css('position:relative;width:122px;height:156px;border-radius:14px;overflow:hidden;box-shadow:0 6px 18px rgba(15,23,42,.14)')}>
          ...
          <div style={css('position:absolute;top:8px;right:8px;width:24px;height:24px;border-radius:50%;background:#0F172A;display:flex;align-items:center;justify-content:center;cursor:pointer')}>
