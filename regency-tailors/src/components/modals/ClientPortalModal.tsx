                      ...
                      <>
                        ...
                        {currentMeasurement && (
                          <div className="bg-white border border-[#E0D8CB] rounded-2xl p-4 sm:p-6 space-y-5 shadow-2xs">
                            ...
                            {/* DETAILED MEASUREMENT SECTIONS — every garment
                                complete, from the canonical definitions. The
                                five blocks here were written out by hand and
                                the coat stopped at X-Back, so Collar, Jacket
                                Length and Waistcoat Length never reached this
                                screen. */}
                            <MeasurementDetailBlocks
